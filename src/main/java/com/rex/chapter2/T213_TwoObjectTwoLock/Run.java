package com.rex.chapter2.T213_TwoObjectTwoLock;
...
public class Run {
    public static void main(String[] args) {
        ...
        MyThreaA myThreaA = new MyThreaA(hasSelfPrivateNum1);
        myThreaA.start();

        HasSelfPrivateNum hasSelfPrivateNuma2 = new HasSelfPrivateNum();
        MyThreaB myThreaB = new MyThreaB(hasSelfPrivateNuma2);
        myThreaB.start();
